                        ...
                        <form action="{{route('information.add')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control"
                                           placeholder="Nhập số email ..." name="email">
                                    @error('email')
                                    <div class="text-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Tiện ích</label>
                                    <textarea class="form-control " id="detail" name="utilities" rows="4"></textarea>
                                    @error('utilities')
                                    <div class="text-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control " id="detail" name="short_des" rows="4"></textarea>
                                    @error('short_des')
                                    <div class="text-danger">{{$message}}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Thông tin ưu đãi</label>
                                    <textarea class="form-control " id="content" name="special_offers" rows="4"></textarea>
